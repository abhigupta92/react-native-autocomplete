...
var Autocomplete = function (props) {
    ...
    var itemRenderer = function (item, index) { return (React.createElement(TouchableOpacity, { key: index, onPress: selectItem(item), style: [styles.listItem, listItemContainerStyle] }, customItemRenderer ? (customItemRenderer(item, index)) : (React.createElement(Text, { style: [{ color: textColor }, listItemTextStyle] }, item[labelKey])))); };
